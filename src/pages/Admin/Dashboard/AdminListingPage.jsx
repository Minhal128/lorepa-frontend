    ...
    <div className='min-h-screen space-y-8 pb-10'>
      <div className='bg-white p-6 sm:p-8 rounded-[2.5rem] shadow-sm border border-gray-100'>
        <div className='flex justify-between items-center mb-8'>
          <div>
            <h3 className='text-xl font-black text-gray-900 tracking-tight'>Trailer Management</h3>
            <p className="text-sm text-gray-500 font-medium">Approve and manage trailer listings across the platform.</p>
          </div>
        ...
        <div className='grid grid-cols-1 gap-6'>
          {filteredListings.length > 0 ? filteredListings.map(listing => (
                ...
                <div className='flex gap-1.5'>
                  {['pending', 'approved', 'decline'].map(status => (
                    <button
                      ...
                      className={`flex-1 px-3 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border-2 transition-all ${listing.status.toLowerCase() === status
            ...
            <div className="text-center py-20 bg-gray-50 rounded-[2.5rem] border-2 border-dashed border-gray-200">
              ...
              <p className="text-gray-500 font-bold">No trailers found.</p>
            </div>
          )}
        </div>
      </div>
