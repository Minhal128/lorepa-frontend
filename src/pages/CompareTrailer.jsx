    ...
    return (
        <div className="min-h-screen flex flex-col font-inter text-black">
            ...
            <main className="flex-grow px-4 sm:px-6 lg:px-[3rem] mt-10">
                ...
                {/* Content Section */}
                <motion.div
                    className="mobile-px mt-10"
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.2 }}
                    variants={fadeInUp}
                >
                    <motion.h1 className="text-2xl sm:text-3xl lg:text-4xl mb-2 font-semibold" variants={sectionDelay(1)}>{translationsData.title}</motion.h1>
                    <motion.p className="text-gray-600 text-xs sm:text-sm mb-8" variants={sectionDelay(2)}>{translationsData.postedBy}</motion.p>
                    ...
                    {contentSections.map((section, index) => (
                        ...
                        >
                            {section.title && <h2 className="text-xl sm:text-2xl lg:text-3xl mt-8 mb-4 font-medium">{section.title}</h2>}
                    ...
                    >
                        <h2 className="text-xl sm:text-2xl lg:text-3xl mt-8 mb-4 font-medium">{translationsData.comparisonTableTitle}</h2>
