export const singleTrailerTranslations = {
  en: {
    ...
    faqRenter3A: "To rent a trailer on Lorepa, you must have FAQ clause 27 on your auto insurance policy. Contact your insurer to verify before your reservation. Without this protection, you will not be able to rent.",
    ...
    faqOwner2A: "Your first rental is free — you keep 100% of the amount. From the second rental onward, Lorepa retains an 8% service fee. For example, on a $100 rental, you receive $92 net. Payment is deposited to your bank account via Interac on the Monday following the end of your rental.",
  ...
  fr: {
    ...
    faqRenter3A: "Pour louer une remorque sur Lorepa, vous devez disposer de la clause FAQ 27 sur votre police d'assurance automobile. Contactez vos assurances pour vérifier avant d'effectuer une réservation. Sans cette protection, vous ne pourrez pas louer.",
