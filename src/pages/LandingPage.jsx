    ...
    fr: {
        ...
        faqContent: {
            renters: [
                ...
                { question: "L'assurance est-elle incluse dans ma location ?", answer: "Pour louer une remorque sur Lorepa, vous devez disposer de la clause FAQ 27 sur ta police d'assurance automobile. Contactez vos assurances pour vérifier avant d'effectuer une réservation. Sans cette protection, vous ne pourrez pas louer." },
