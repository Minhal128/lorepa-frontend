...
const translations = {
    en: {
        ...
        popularLocations: "Our Featured Cities",
        carHauler: "Choose your trailer",
    ...
    es: {
        ...
        popularLocations: "Nuestras ciudades destacadas",
        "carHauler": "Elige tu remolque",
    ...
    fr: {
        ...
        popularLocations: "Nos Villes Vedettes",
        carHauler: "Choisis ta remorque",
        faq: "Questions fréquemment posées",
        faqDesc: "Tout ce que vous devez savoir sur Lorepa.",
        heroLabel: "Location de Remorques, Réinventée",
        heroHeadingLine1: "Remorques proches.",
        heroHeadingHighlight: "Location facile.",
        heroHeadingLine2: "Première communauté, Québécoise !",
        ...
        faqContent: {
            renters: [
                ...
                { question: "L'assurance est-elle incluse dans ma location ?", answer: "Pour louer une remorque sur Lorepa, vous devez disposer de la clause FAQ 27 sur votre police d'assurance automobile. Contactez vos assurances pour vérifier avant d'effectuer une réservation. Sans cette protection, vous ne pourrez pas louer." },
            ...
            owners: [
                ...
                { question: "Combien puis-je gagner avec Lorepa ?", answer: "Votre première location est offerte — vous conservez 100% du montant. À partir de la deuxième, Lorepa retient 8% de frais de service. Par exemple, pour une location à 100$, vous gagnez 92$ net. Le paiement est déposé sur votre compte bancaire par Interac le lundi suivant la fin de ta location." },
