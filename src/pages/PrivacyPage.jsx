...
const privacyPolicyTranslations = {
  en: {
    ...
    contactAddress: "📬 Mailing address: 551, Av Jeanne D'arc, Montréal, H1W 3T2, Québec, Canada",
    ...
    registeredAddress: "Registered Address: 551, Av Jeanne D'arc, Montreal, Quebec, H1W 3T2",
  ...
  es: {
    ...
    contactAddress: "📬 Dirección postal: 551, Av Jeanne D'arc, Montréal, H1W 3T2, Québec, Canadá",
    ...
    registeredAddress: "Dirección Registrada: 551, Av Jeanne D'arc, Montreal, Quebec, H1W 3T2",
    ...
    websiteCreator: "Creador del sitio web: Bayo Alabi (Easywordtech )",
  ...
  fr: {
    ...
    contactEmail: "📧 Email : mayukwa.rodrigue@gmail.com",
    contactAddress: "📬 Adresse postale : 551, Av Jeanne D'arc, Montréal, H1W 3T2, Québec, Canada",
    ...
    registeredAddress: "Adresse enregistrée : 551, Av Jeanne D'arc, Montréal, Québec, H1W 3T2",
    ...
    websiteCreator: "Créateur du site web : Bayo Alabi (Easywordtech )",
        ...
        <div className='space-y-10 text-sm leading-relaxed'>
          {sections.map((section, index) => (
            ...
            >
              ...
              <div className='text-gray-800 text-sm sm:text-base'>{section.content}</div>
            </motion.div>
          ))}
        </div>
      </div>
