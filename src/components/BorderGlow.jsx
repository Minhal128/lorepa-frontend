...
export default function BorderGlow({
  ...
  return (
    <div
      ...
      className={`relative grid isolate border border-white/20 ${className}`}
      style={{
        background: backgroundColor,
        borderRadius: `${borderRadius}px`,
        transform: 'translate3d(0, 0, 0.01px)',
        boxShadow: '0 4px 24px rgba(37,99,235,0.08), 0 1px 6px rgba(0,0,0,0.04)',
      }}
    >
      ...
      <div className="flex flex-col relative overflow-auto" style={{ zIndex: 1 }}>
        {children}
      </div>
    </div>
  );
